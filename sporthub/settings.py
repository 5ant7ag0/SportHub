# Gestiona la Base de Datos Híbrida.
# quí se conecta Django a SQLite
# y MongoDB a través de MongoEngine
...
# Modo Debug (True = más información en errores, False = más seguro)
DEBUG = True

# Hosts permitidos ( '*' significa todos, útil para desarrollo local)
ALLOWED_HOSTS = ['*']
